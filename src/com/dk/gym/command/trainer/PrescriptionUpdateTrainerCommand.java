...
/**
 * The Class PrescriptionUpdateTrainerCommand.
 */
public class PrescriptionUpdateTrainerCommand implements ActionCommand {
    ...
    public RouterPage execute(SessionRequestContent content) throws CommandException {
        ...
        String pageUrl = PageConstant.PAGE_TRAINER_READ_PRESCRIPTION;
